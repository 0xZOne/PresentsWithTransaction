...
final class MetalKitViewController: UIViewController {
    ...
    let vertices: [Vertex] = [
        Vertex(position: SIMD3<Float>(x: -1, y: 1, z: 0), color: SIMD4<Float>(1,0,0,1)),
        Vertex(position: SIMD3<Float>(x: 1, y: 1, z: 0), color: SIMD4<Float>(1,1,0,1)),
        Vertex(position: SIMD3<Float>(x: -1, y: -1, z: 0), color: SIMD4<Float>(0,1,0,1)),
        Vertex(position: SIMD3<Float>(x: 1, y: -1, z: 0), color: SIMD4<Float>(0,1,1,1))
    ]
